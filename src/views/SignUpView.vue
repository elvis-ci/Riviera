<template>
  ...
  >
    <div
      class="w-full max-w-md bg-background border border-border rounded-2xl shadow-lg p-8 sm:p-10"
    >
      <h1
        id="signup-heading"
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            class="w-full border border-border rounded-lg px-4 py-2 text-sm bg-transparent focus:ring-2 focus:ring-accent focus:border-accent outline-none transition"
          />
        </div>
        ...
        <p class="text-sm text-center mt-4 text-text/80">
          ...
          <router-link
            to="/signin"
            class="text-accent font-medium hover:underline focus:underline focus:outline-none"
          >
            Sign in
          </router-link>
        </p>
