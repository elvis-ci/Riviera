<template>
  <main>
    ...
    >
      <!-- Overlay for mobile -->
      <div class="absolute inset-0 md:hidden bg-gradient-to-t from-background/95 via-background/70 to-transparent z-0"></div>

      <!-- Text Content -->
      <div
        class="relative w-full my-auto md:w-3/5 px-6 sm:px-10 md:px-16 sm:py-20 flex flex-col items-start text-start z-10 animate-fadeIn"
      >
        <h1 class="text-3xl sm:text-5xl md:text-6xl font-serif font-semibold text-heading leading-tight mb-4">
          Timeless <span class="sm:text-accent">Elegance</span> in Every Scent
        </h1>
        <p class="text-base sm:text-lg md:text-xl text-text/80 max-w-md mx-auto md:mx-0 leading-relaxed mb-8">
          Discover fragrances that capture your essence — crafted for those who value sophistication, simplicity, and self-expression.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center md:justify-start">
          ...
          <RouterLink
            to="/about"
            class="border border-border text-center hover:bg-accent/30 hover:border-accent text-heading py-3 px-8 rounded-full text-base sm:text-lg font-medium transition-all focus:outline-none focus:ring-2 focus:ring-accent/30 w-full sm:w-auto"
          >
            Learn More
          </RouterLink>
        </div>
      ...
      >
        ...
        />
        <div class="absolute inset-0 bg-gradient-to-l from-background/70 via-transparent to-background/30"></div>
      </div>
    ...
    <!-- Bento Categories -->
    <section class="py-24 sm:px-6 text-text bg-background relative overflow-hidden" aria-labelledby="fragrance-categories-heading">
      <div class="max-w-7xl mx-auto relative z-10 text-center mb-16">
        <h2 id="fragrance-categories-heading" class="text-4xl sm:text-5xl font-heading text-heading mb-4 tracking-tight">
      ...
      <div class="max-w-6xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-10">
        ...
        <div class="w-full md:w-1/2 space-y-6">
          ...
          <p class="text-text/80 leading-relaxed">
            At <span class="font-semibold text-accent-hover">Echelon Fragrances</span>, we believe every scent tells a story. Our artisans blend rare ingredients from around the world to create perfumes that celebrate individuality, elegance, and timeless sophistication.
          </p>
          <RouterLink
            to="/about"
        ...
        <div class="grid gap-10 md:grid-cols-3">
          <article class="p-6 bg-surface rounded-2xl shadow-md">
            <p class="italic text-text/80 mb-4">
              “Every fragrance feels like it was made just for me. The attention to detail is unmatched.”
            </p>
            <h3 class="font-semibold text-heading">— Ada O., Lagos</h3>
          </article>
          <article class="p-6 bg-surface rounded-2xl shadow-md">
            <p class="italic text-text/80 mb-4">
              “I’ve never had so many compliments on a scent before. Truly luxurious and long-lasting.”
            </p>
          ...
          <details class="faq-item border-b border-border pb-4">
            ...
            <div class="faq-content">
              <p class="mt-2 text-text/80 leading-relaxed">
                Our fragrances are designed to last 6–8 hours depending on your skin type and environment.
              </p>
            </div>
          </details>
          <details class="faq-item border-b border-border pb-4">
            ...
            <div class="faq-content">
              <p class="mt-2 text-text/80 leading-relaxed">
                Yes. We design scents that transcend gender — elegant, expressive, and balanced for everyone.
              </p>
            </div>
          </details>
          <details class="faq-item border-b border-border pb-4">
            ...
            <div class="faq-content">
              <p class="mt-2 text-text/80 leading-relaxed">
                We currently ship across Africa, Europe, and North America with reliable global logistics partners.
              </p>
            </div>
          </details>
        </div>
    ...
    <section class="py-16 md:py-20 bg-secondary/10 text-center px-6">
      <div class="max-w-2xl mx-auto space-y-6">
        ...
        <form class="flex flex-col sm:flex-row gap-4 justify-center items-center" aria-label="Subscribe to our newsletter">
          <input
            type="email"
...
/* FAQ styling */
.faq-item summary { list-style: none; cursor: pointer; padding-right: 1.75rem; position: relative; transition: color 0.3s ease; }
.faq-item summary::after { content: "›"; position: absolute; right: 0; top: 0; font-size: 1.4rem; color: var(--color-accent); transition: transform 0.3s ease; }
.faq-item[open] summary::after { transform: rotate(90deg); }
.faq-content { max-height: 0; overflow: hidden; opacity: 0; transform: translateY(-0.5rem); transition: max-height 0.45s ease, opacity 0.35s ease, transform 0.35s ease; }
.faq-item[open] .faq-content { max-height: 500px; opacity: 1; transform: translateY(0); }
</style>
