    ...
    <div class="">
      <div class="mx-2 relative mb-0 max-w-2xl sm:mx-auto lg:mb-8 lg:h-15">
        ...
        <button
          ...
          class="absolute h-full top-1/2 right-0 -translate-y-1/2 lg:hidden py-1 px-2 border border-border rounded-lg bg-surface text-heading font-medium flex justify-between items-center"
        >
          <IconMdiFilter />
